...
import hello.advanced.aop.order.aop.member.annotation.ClassAop;
import hello.advanced.aop.order.aop.member.annotation.MethodAop;
...
public class ParameterTest {
    ...
    static class ParameterAspect {
        @Pointcut("execution(* hello.advanced.aop.order.aop.member..*.*(..))")
